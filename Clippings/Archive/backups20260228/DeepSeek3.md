...
**Дата сохранения:** 13.01.2026, 23:12:17
...
2. **SingleFile** (лучший вариант) — сохраняет всю страницу в один HTML файл
3. **Save Page WE** — альтернатива SingleFile
4. **GoFullPage** — делает скриншот всей страницы (но не текстовый)
5. **Клавиши в браузере:**

- `Ctrl+S` (Windows) / `Cmd+S` (Mac) → "Веб-страница полностью"
- Это сохранит HTML + папку с ресурсами
6. `Ctrl+S` (Windows) / `Cmd+S` (Mac) → "Веб-страница полностью"
7. Это сохранит HTML + папку с ресурсами
...
4. Автоопределение ролей
5. Сохранение с датами
6. Предпросмотр перед сохранением
7. Экспорт в разные форматы
...
- Сохраните
3. Нажмите `Ctrl+D` (или `Cmd+D` на Mac)
4. В поле **"Адрес"** или **"URL"** вставьте код выше
5. Назовите, например, "Save DeepSeek Chat"
6. Сохраните
7. **Использование:**
...
8. Откройте чат с DeepSeek
9. Нажмите на эту закладку в панели закладок
10. Файл скачается автоматически
...
```
1. Теперь просто вводите в консоли: `saveDeepSeekChat()`
...
- **Chrome/Edge**: [https://chromewebstore.google.com/detail/tampermonkey/dhdgffkkebhmkfjojejmpbldmpobfkfo](https://chromewebstore.google.com/detail/tampermonkey/dhdgffkkebhmkfjojejmpbldmpobfkfo)
- **Firefox**: [https://addons.mozilla.org/ru/firefox/addon/tampermonkey/](https://addons.mozilla.org/ru/firefox/addon/tampermonkey/)
- **Safari**: [https://apps.apple.com/app/tampermonkey/id1482490089](https://apps.apple.com/app/tampermonkey/id1482490089)
2. **Chrome/Edge**: [https://chromewebstore.google.com/detail/tampermonkey/dhdgffkkebhmkfjojejmpbldmpobfkfo](https://chromewebstore.google.com/detail/tampermonkey/dhdgffkkebhmkfjojejmpbldmpobfkfo)
3. **Firefox**: [https://addons.mozilla.org/ru/firefox/addon/tampermonkey/](https://addons.mozilla.org/ru/firefox/addon/tampermonkey/)
4. **Safari**: [https://apps.apple.com/app/tampermonkey/id1482490089](https://apps.apple.com/app/tampermonkey/id1482490089)
...
3. Кнопка покажет индикатор загрузки
4. Файл скачается с именем `DeepSeek1.md`, `DeepSeek2.md` и т.д.
5. Появится уведомление в правом верхнем углу
6. **Горячая клавиша**: `Ctrl+Alt+S` (Windows) или `Cmd+Alt+S` (Mac)
...
2. Установите **Violentmonkey**: [https://violentmonkey.github.io/](https://violentmonkey.github.io/)
...
3. Папка: `~/Downloads/`
4. Условие: `Имя` `содержит` `DeepSeek`
5. Действие: `Переместить` в вашу папку Obsidian
