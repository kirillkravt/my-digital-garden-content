...
superdough is a simple web audio sampler and synth, intended for live coding. It is the default output of [strudel](https://strudel.cc/). This package has no ties to strudel and can be used to quickly bake your own music system on the web.

## [](https://codeberg.org/uzu/strudel/src/branch/main/packages/superdough/README.md#install)Install
...
## [](https://codeberg.org/uzu/strudel/src/branch/main/packages/superdough/README.md#use)Use
...
## [](https://codeberg.org/uzu/strudel/src/branch/main/packages/superdough/README.md#api)API

### [](https://codeberg.org/uzu/strudel/src/branch/main/packages/superdough/README.md#superdough-value-deadline-duration)superdough(value, deadline, duration)
...
### [](https://codeberg.org/uzu/strudel/src/branch/main/packages/superdough/README.md#registersynthsounds)registerSynthSounds()
...
### [](https://codeberg.org/uzu/strudel/src/branch/main/packages/superdough/README.md#samples-samplemap)samples(sampleMap)
...
#### [](https://codeberg.org/uzu/strudel/src/branch/main/packages/superdough/README.md#sample-map-object)sample map object
...
#### [](https://codeberg.org/uzu/strudel/src/branch/main/packages/superdough/README.md#loading-samples-from-a-json-file)loading samples from a json file
...
#### [](https://codeberg.org/uzu/strudel/src/branch/main/packages/superdough/README.md#loading-samples-from-a-github-repo)loading samples from a github repo
...
### [](https://codeberg.org/uzu/strudel/src/branch/main/packages/superdough/README.md#initaudioonfirstclick)initAudioOnFirstClick()

Initializes audio and makes sure it is playable after the first click in the document. A click is needed because of the [Autoplay Policy](https://www.w3.org/TR/autoplay-detection/). You can call this function when the document loads. Then just make sure your first call of `superdough` happens after a click of something.

## [](https://codeberg.org/uzu/strudel/src/branch/main/packages/superdough/README.md#credits)Credits
