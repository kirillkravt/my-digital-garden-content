...
message_count: 114
exported_at: 2026-05-24T13:52:12.280Z
---
...
Достигнут предел длины. DeepSeek может прочитать только первые 64%.Вижу проблему. Сервер не запускается из-за ошибок. Давайте восстановим работоспособность шаг за шагом:
