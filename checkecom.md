...
| msgType | string (enum: 'checkecom') | **Да** | Тип сообщения - check |
...
| cardIssuerCountry | string (maxLength: 2) | Нет | Страна банка эмитента |
...
| addData | string (maxLength: 5336, example: 'MjAxMDIwUHVyY2hhc2VJZD0yODg4OTI4MjgyMDQwMTh7Im1pc2MiOiI8PDw_Pz4-In0') | Нет | Набор контейнеров в TLV-формате, представленный в Base64Url |